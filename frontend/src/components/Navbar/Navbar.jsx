...
const Navbar = ({setShowLogin}) => {
  ...
  return (
    <div className='navbar'>
        <Link to='/app'><img src={assets.logo} alt="" className='logo' /></Link>
        <ul className="navbar-menu">
        <Link to='/app' onClick={()=>setMenu("home")} className={menu==="home"?"active":""}>home</Link>
        ...
        <label for="visual-toggle" id="visual-toggle-button" onclick="visualMode()" >
            ...
            <div className="navbar-search-icon">
                <Link to='/app/cart'><img className='basketlogo' src={assets.basket_icon} alt="" /></Link>
            ...
            :<div className='navbar-profile'>
              ...
              <ul className="nav-profile-dropdown">
                <li onClick={()=>navigate('/app/myorders')}><img src={assets.bag_icon} alt="" /><p>Orders</p></li>
                <hr />
